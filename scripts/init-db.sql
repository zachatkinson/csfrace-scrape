...
-- Function: Clean expired cache entries (Production optimized)
...
DO $$
BEGIN
    RAISE NOTICE 'Production database schema initialized successfully!';
    RAISE NOTICE 'Tables: jobs, batches, content, images, cache';
